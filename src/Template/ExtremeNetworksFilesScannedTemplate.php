<?php
    ...
    class ExtremeNetworksFilesScannedTemplate {
        ...
        public function __construct(OpenReport $openReport) {
            ...
            $tbl .= '<th style="width: 50%"><span style="color: #FFFFFF; font-weight: bold;">Filename</span></th>';
            $tbl .= '<th style="text-align:center; width: 10%"><span style="color: #FFFFFF; font-weight: bold;">Lines</span></th>';
            $tbl .= '<th style="text-align:center; width: 10%"><span style="color: #FFFFFF; font-weight: bold;">Size</span></th>';
            $tbl .= '<th style="text-align:center; width: 30%"><span style="color: #FFFFFF; font-weight: bold;">Templates</span></th>';
            $tbl .= '</tr>';
